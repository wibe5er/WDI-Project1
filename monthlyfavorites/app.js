...
var oldMovieBox = $("#box2-return").html();
...
function changeMusicChoice (random) {
...
} // end of changeMusicChoice function
...
function changeMovieChoice (random) {
	$(".movieBlock").on("click","#changeMovieButton", function (e) {
		e.preventDefault();
		
		$("#box2-new").fadeOut(500);

		$(".movieBlock").html(oldMovieBox);
		listenForMovieSearch();                
	}); 	
} // end of changeMovieChoice function

//traileraddict API doesn't allow JSON and only XML which doesn't allow client side ********************
//traileraddict API doesn't allow JSON and only XML which doesn't allow client side ********************
